...
import { home, info } from './controllers/core'
import { create as userCreate } from './controllers/users'
import { create as serverCreate, remove as serverRemove, leave as serverLeave } from './controllers/servers'
import { create as inviteCreate, accept as inviteAccept } from './controllers/invites'
import { post as messagePost } from './controllers/messages'
